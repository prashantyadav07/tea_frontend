    ...
    <div className="min-h-screen pt-28 sm:pt-32 pb-20 px-4 bg-background">
      <div className="max-w-4xl mx-auto text-center space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 my-12 sm:my-20">
          ...
          <ScrollReveal delay={0.4} className="aspect-square bg-gray-100 rounded-[2rem] overflow-hidden md:translate-y-12">
        ...
        <ScrollReveal delay={0.6}>
          <h2 className="font-display text-3xl sm:text-4xl font-bold mb-4 sm:mb-6">Sustainable Sourcing</h2>
        ...
        <ScrollReveal delay={0.8} className="mt-12 sm:mt-24 flex flex-col items-center">
          <AnimatedLetterText text="Borsillah" letterToReplace="o" className="text-5xl sm:text-7xl md:text-9xl mb-8" />
